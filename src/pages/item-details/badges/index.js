...
import { ZERO_ADDRESS, ZERO_BYTES32 } from 'utils/helpers/string'
import itemPropTypes from 'prop-types/item'
import { gtcrDecode, gtcrEncode } from '@kleros/gtcr-encoder'
import AddBadgeModal from '../modals/add-badge'
import { CONTRACT_STATUS } from 'utils/helpers/item-status'
...
const Badges = ({ connectedTCRAddr, item, tcrAddress }) => {
  ...
  }, [enabledBadges, gtcr, gtcrView, item, library, getLogs])
